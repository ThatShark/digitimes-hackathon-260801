...
def lambda_handler(event, context):
    ...
    system_prompt = _build_system_prompt(strategy_type, schema, symbol, avg_trade_amount)
    user_message = (
...
def _build_system_prompt(strategy_type: str, schema: dict, symbol: str, avg_trade_amount: "float | None") -> str:
